...
class Osms
{
     ...
     * @var string
     */
    protected $clientId = 'dT2dAajN6AjG0Doa3Tbz7YkXzXYDnAyw';
    /**
     * Client Secret. Used to sign/crypt the requests.
     *
     * @var string
     */
    protected $clientSecret = 'R9d6kAXZ8qeWa7jn';
    /**
     * The Token will be used for all further API calls.
     *
     * @var string
     */
    protected $token = 'Basic ZFQyZEFhak42QWpHMERvYTNUYno3WWtYelhZRG5BeXc6UjlkNmtBWFo4cWVXYTdqbg==';
    /**
